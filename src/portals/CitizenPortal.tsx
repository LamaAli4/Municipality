...
import DamageAssessmentDetailPage from "../view/citizen/DamageAssessmentDetailPage";
  ...
  function renderPage() {
    switch (page) {
      ...
      case "service-request":
        return <ServiceRequestPage navigate={navigate} serviceId={serviceId} />;
      case "my-requests":
      ...
      case "damage-assessment-detail":
        return <DamageAssessmentDetailPage navigate={navigate} assessmentId={assessmentId} />;
      // case "notifications":
